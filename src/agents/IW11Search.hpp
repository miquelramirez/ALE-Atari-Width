#ifndef __IW11_SEARCH_HPP__
#define __IW11_SEARCH_HPP__
...
class IW11Search : public SearchTree {
    public:
	IW11Search(RomSettings *, Settings &settings, ActionVect &actions, StellaEnvironment* _env);
...
protected:	
	...
	ALERAM 					m_ram;
	std::vector< aptk::Bit_Matrix* >	m_act_novelty_table;
